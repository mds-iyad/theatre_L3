...
class AppTablesData(QDialog):
    ...
    def refreshAllTables(self):
        ...
        self.refreshTable(self.ui.labelRepVue, self.ui.tableRepVue, "SELECT noSpec, dateRep, promoRep, nbPlacesRestantes FROM LesRepresentations")
        ...
        self.refreshTable(self.ui.dossiersvue, self.ui.tableDossiersVue, "SELECT noDos, montant FROM LesDossiers")
        self.refreshTable(self.ui.label_dossiers, self.ui.tableDossiers, "SELECT noDos FROM LesDossiers_base")
        self.refreshTable(self.ui.label_tickets, self.ui.tableTickets, "SELECT noSpec, dateRep, noPlace, noRang, dateEmTick, noDos, libelleCat FROM LesTickets")
